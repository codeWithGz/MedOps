...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Professional p1 = new Professional(null, "cody", "cody@gmail.com", "codyTheBest", AccountStatus.ACTIVE);
		Professional p2 = new Professional(null, "with", "with@gmail.com", "withTheBest", AccountStatus.ACTIVE);
